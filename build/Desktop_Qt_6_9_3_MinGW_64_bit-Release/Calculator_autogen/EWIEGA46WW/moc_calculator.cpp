...
template <> constexpr inline auto Calculator::qt_create_metaobjectdata<qt_meta_tag_ZN10CalculatorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'CalculatorClicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'CurrencyButtonClicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'ConvertCurrency'
...
void Calculator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->EqualsButton(); break;
        case 3: _t->ClearButton(); break;
        case 4: _t->CalculatorClicked(); break;
        case 5: _t->CurrencyButtonClicked(); break;
        case 6: _t->ConvertCurrency(); break;
        case 7: _t->ReplayFinished((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        case 8: _t->ClearCurrency(); break;
        default: ;
        }
    }
